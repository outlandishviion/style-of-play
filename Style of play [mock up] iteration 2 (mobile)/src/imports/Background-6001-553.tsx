...
export default function Background() {
  return (
    <div className="bg-[#c774f5] box-border content-stretch flex items-center overflow-clip relative rounded-[999px] shadow-[0px_0px_10px_3px_#c774f5] size-full" data-name="background">
      <LocalPresetBtn />
    </div>
  );
}