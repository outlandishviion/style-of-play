...
export default function Background() {
  return (
    <div className="bg-[#b12e5f] box-border content-stretch flex items-center overflow-clip relative rounded-[999px] shadow-[0px_0px_10px_3px_#b12e5f] size-full" data-name="background">
      <LocalPresetBtn />
    </div>
  );
}