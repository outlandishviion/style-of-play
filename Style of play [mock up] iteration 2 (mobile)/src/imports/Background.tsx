...
export default function Background() {
  return (
    <div className="bg-[#42a5f5] box-border content-stretch flex items-center overflow-clip relative rounded-[999px] shadow-[0px_0px_10px_3px_#42a5f5] size-full" data-name="background">
      <LocalPresetBtn />
    </div>
  );
}